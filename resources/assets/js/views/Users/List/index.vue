<template lang="pug">
  ...
  +b.Users-list
    +e.top-controls
      +e.btn.A(href="#", v-on:click.prevent="getItems()", :disabled="loading") Обновить
      +e.right
        +e.A.btn.-page.-md(href="#", @click.prevent="prevPage()", v-if="previousPageUrl") Назад
        +e.A.btn.-page.-md(href="#", @click.prevent="nextPage()", v-if="nextPageUrl") Вперёд
    ...
    +e.controls
      +e.A.btn.-page(href="#", @click.prevent="prevPage()", v-if="previousPageUrl") Назад
      +e.A.btn.-page(href="#", @click.prevent="nextPage()", v-if="nextPageUrl") Вперёд
</template>
